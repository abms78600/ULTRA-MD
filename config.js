...
const defaultOwner = '923406783423';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS = 'Hacker🪲';  // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER = '923406783423';  // put your number here
global.SESSION_ID = process.env.SESSION_ID = 'session id';  // put your session id here

global.mods = []
global.prems = []
global.allowed = ['92406783423', '923051391007']
